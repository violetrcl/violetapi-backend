...
import csu.lch.violetapi.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import csu.lch.violetapi.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import csu.lch.violetapi.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
     ...
     * 新增
     *
     * @param userInterfaceInfoAddRequest   用户接口关系新增请求体
     ...
     * 更新
     *
     * @param userInterfaceInfoUpdateRequest    用户接口关系更新请求体
     * @param request   HttpServletRequest
     * @return  用户接口关系更新是否成功
     */
    @PostMapping("/update")
     ...
     * 获取列表（仅管理员可使用）
     *
     * @param userInterfaceInfoQueryRequest     用户接口关系查询请求体
     * @return  用户接口关系列表
     */
    @GetMapping("/list")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
